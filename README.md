...
`Error if not registered as a seller in the EC2 Marketplace : "AccountId '1234567890', You are not authorized to use the requested product. Please complete the seller registration null."`
